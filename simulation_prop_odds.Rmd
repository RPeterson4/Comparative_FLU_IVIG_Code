...
Sim_full = function(S){
  ...
  for (i in 1:S){
    ...
    test_stats = rbind(test_stats,c(test_slide1,test_slide2,test_binary1,test_binary2,
						...
						test_WR1, test_WR5,test_surv1,test_surv2,test_cox1,test_cox2,
    ...
    trt_stats = rbind(trt_stats,c(trt_slide1,trt_slide2,trt_binary1,trt_binary2,
						...
						trt_WR1, trt_WR5,trt_surv1,trt_surv2,trt_cox1,trt_cox2,
...
headers3 = c("Sliding Dichotomy 1", "Sliding Dichotomy 2", "Simple Logistic 1",
             "Simply Logistic 2", "Prop. Odds 1", "Prop. Odds 2",
             "Cont. Ratio 1", "Cont. Ratio 2", "Win Ratio 1", "Win Ratio 5",
		"AFT 1", "AFT 2", "Cox 1", "Cox 2","Ordinal GEE 1", "Ordinal GEE 2")

pow = mp(simres,8)
t1 = mt(simres,8)
t2 = colMeans(t1)
mat = cbind(apply(pow,2,powfun),c(exp(t2[1:4]),exp(-t2[5:8]),t2[9:10],-t2[11:12],
		exp(t2[13:14]),2-exp(t2[15:16])))
rownames(mat) = headers3
colnames(mat) = c("Empirical Power","Average Coefficient Value")
